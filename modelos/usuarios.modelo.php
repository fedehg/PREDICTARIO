...
============================================*/
  ...
  $stmt =(new Conexion)->conectar()->prepare("UPDATE $tabla SET nombre = :nombre, password = :password,
   perfil = :perfil, foto = :foto WHERE usuario = :usuario");
    ...
    static public function mdlActualizarUsuario($tabla, $item1, $valor1, $tem2, $valor2){

           $stmt =(new Conexion)->conectar()->prepare("UPDATE $tabla SET $item1 = :$item1 WHERE $item2 = :$item2");
